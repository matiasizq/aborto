...
// Interface for simulation options used within the component
...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Added class property declarations to fix TypeScript errors in CommonClass
    class CommonClass {
      width: number;
      height: number;
      aspect: number;
    ...
    // Added class property declarations to fix TypeScript errors in MouseClass
    class MouseClass {
      mouseMoved: boolean;
      ...
      listenerTarget: (Window & typeof globalThis) | null;
    ...
    // Added class property declarations to fix TypeScript errors in AutoDriver
    class AutoDriver {
      mouse: MouseClass;
      manager: any;
      enabled: boolean;
...
`;
    ...
    // Added class property declarations to fix TypeScript errors in ShaderPass and its subclasses
    class ShaderPass {
      props: any;
      uniforms: any;
      scene: THREE.Scene;
      ...
      init() {
        if (this.uniforms) {
          ...
          this.plane = new THREE.Mesh(this.geometry as THREE.PlaneGeometry, this.material);
    ...
    class Advection extends ShaderPass {
      ...
      update(args: { dt: any, isBounce: any, BFECC: any }) {
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props: any) {
        ...
        // Fix: Explicitly cast material to RawShaderMaterial to access uniforms property
        if (this.mouse) {
    ...
    class Viscous extends ShaderPass {
      ...
      update(args: { viscous: any, iterations: any, dt: any }) {
    ...
    // Added class property declarations to fix TypeScript errors in Simulation
    class Simulation {
    ...
    // Added class property declarations to fix TypeScript errors in Output
    class Output {
    ...
    // Added class property declarations to fix TypeScript errors in WebGLManager
    class WebGLManager {
      props: any;
      output: Output | null;
